Feature: Banking Operations
  ...
  Scenario: Transfer funds from USD to EUR account
    ...
    And the account balance for account "B-67890" should be "$1100"
...
#Feature: Banking Operations
  ...
  Scenario: Process Orders
    Given the following orders exist:
      ...
      | 102      | Banana  | 3        |
      | 103      | Orange  | 2        |
#    List.get(0).get(key)=get is value product is key or quantatiy
#    List.get(0).get("Product")= to get apple
#    List.get(1).get("Product")= to get banana
#  List.get(2).get("Product")= to get orange
